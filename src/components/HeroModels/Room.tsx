...
export function Room(props: JSX.IntrinsicElements["group"]) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      />
      <mesh geometry={(nodes.body1_blinn1_0 as THREE.Mesh).geometry} material={bodyMaterial} />
      <mesh geometry={(nodes.cabin_blinn1_0 as THREE.Mesh).geometry} material={tableMaterial} />
      <mesh
        geometry={(nodes.chair_body_blinn1_0 as THREE.Mesh).geometry}
        material={chairMaterial}
      />
      <mesh geometry={(nodes.comp_blinn1_0 as THREE.Mesh).geometry} material={compMaterial} />
      <mesh
        ref={screensRef}
      ...
      <mesh
        ...
        material={materials.blinn1}
      />
      <mesh geometry={(nodes.table_blinn1_0 as THREE.Mesh).geometry} material={tableMaterial} />
      <mesh
